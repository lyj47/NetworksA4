...
//		args[0] = "Peer1"; args[1] = "127.0.0.1"; args[2] = "1111"; args[3] = "files/P1"; args[4] = "127.0.0.5"; args[5] = "2222"; //THIS IS PURELY FOR TESTING!
		...
		try {
			if (numArgs != 4 && numArgs != 6) {
				...
				System.err.println("   java A4 <peer name> <peer IP> " + "<peer lookup port> <path to files> "
			...
			new Peer(peerName, peerIP, lPort, filesPath, neighborIP, neighborPort).run();
	...
	/*
	 * Make a DNS call, if needed. If the argument is a symbolic host name, return
	 * its IP address as a String representation of its dotted decimal address.
	 * Example: return "127.0.0.1" given "localhost" If the argument is the string
	 * representation of an IP address in dotted decimal, just return it (no DNS
	 * call is made). Example: return "127.0.0.1" given "127.0.0.1"
	 */
